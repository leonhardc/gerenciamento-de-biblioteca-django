...
class Categoria(models.Model):
    cod_categoria = models.CharField(max_length=4, blank=False, null=False, verbose_name='Código da Categoria')
    nome_categoria = models.CharField(max_length=100, blank=False, null=False, verbose_name='Nome da Categoria')
    desc_categoria = models.CharField(max_length=500, blank=True, null=True, verbose_name='Descrição')
